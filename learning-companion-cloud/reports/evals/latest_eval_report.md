...
- Generated at: `2026-07-06T09:57:10`
...
| learning_agent | 210 | 206 | 0.981 | 0.996 | L-GAP-RAG-001, L-GAP-RAG-002, L-GAP-RAG-003, L-GAP-RAG-004 | - |
...
### learning_agent
- `L-GAP-RAG-001` (known gap, score `0.833`): missing keyword: 父亲的话
- `L-GAP-RAG-002` (known gap, score `0.833`): missing keyword: 借物喻人
- `L-GAP-RAG-003` (known gap, score `0.667`): missing keyword: 质数, missing keyword: 合数
- `L-GAP-RAG-004` (known gap, score `0.833`): missing keyword: 听力原文
