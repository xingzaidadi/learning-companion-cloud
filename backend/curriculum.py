...
CURRICULUM: dict[str, list[dict[str, Any]]] = {
    ...
    "english_fltrp": [
        {
            "unit": "Starter/Unit 1：个人信息与学校生活",
            "lessons": ["自我介绍", "学校与班级", "日常问答"],
            "points": ["greetings", "name/age/class", "classroom language"],
            "quiz_focus": ["英汉互译", "选择合适问答", "写一个短句"],
            "scope_note": "按三年级起点五上基础表达，不扩展到长篇写作。",
        },
        {
            "unit": "Unit 2：家庭、朋友与日常活动",
            "lessons": ["family", "friends", "daily routines"],
            "points": ["family words", "he/she", "simple present"],
            "quiz_focus": ["词义", "句型填空", "造句"],
            "scope_note": "只考常见词和简单句。",
        },
        {
            "unit": "Unit 3：食物、购物与喜好",
            "lessons": ["food", "shopping", "likes"],
            "points": ["food words", "How much", "like/love"],
            "quiz_focus": ["词汇", "情景选择", "短句表达"],
            "scope_note": "不扩展复杂语法。",
        },
        {
            "unit": "Unit 4：动物、地点与自然",
            "lessons": ["animals", "places", "nature"],
            "points": ["animal words", "there be", "where"],
            "quiz_focus": ["词汇", "there be 句型", "问答"],
            "scope_note": "以教材主题词为主。",
        },
        {
            "unit": "Unit 5：节日、时间与计划",
            "lessons": ["festivals", "time", "plans"],
            "points": ["months/days", "festival words", "be going to"],
            "quiz_focus": ["时间表达", "节日词汇", "计划句"],
            "scope_note": "只做五年级可掌握的短句表达。",
        },
    ],
    "english_pep": [
        {
